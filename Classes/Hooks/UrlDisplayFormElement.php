...
class UrlDisplayFormElement extends \TYPO3\CMS\Backend\Form\AbstractNode implements \TYPO3\CMS\Backend\Form\NodeInterface
{
    ...
    public function render()
    {
        ...
        $result['html'] .= "<span onclick=\"return fieldtoclipboard.copyfield(event,'urldisplay')\"><img src='https://cdn0.iconfinder.com/data/icons/fatcow/32x32/clipboard_sign_out.png'/></span> ";
